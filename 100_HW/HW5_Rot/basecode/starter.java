...
public class starter {
    ...
    public static void main(String[] args) {
        ...
        int finalDamage = (int)(Math.max(rawDamage-rivalDefense , 10));
        ...
        //     to (int).
        double rivalFuryRoll = (double)(Math.random()*0.5 +1);
        ...
        int damageDealt = (int)(rivalHealth - rivalHealthRemaining);
